export const dict = {
  ...
  "settings.proxy.section.title": "Network proxy",
  "settings.proxy.section.custom": "Custom proxy",
  "settings.proxy.mode.title": "Proxy mode",
  "settings.proxy.mode.description": "Choose how OpenCode routes network traffic",
  "settings.proxy.mode.none": "No proxy",
  "settings.proxy.mode.system": "Use system proxy",
  "settings.proxy.mode.custom": "Custom proxy",
  "settings.proxy.url.title": "Proxy URL",
  "settings.proxy.url.description": "HTTP, HTTPS, or SOCKS proxy address",
  "settings.proxy.username.title": "Username",
  "settings.proxy.username.description": "Optional credentials for proxy authentication",
  "settings.proxy.password.title": "Password",
  "settings.proxy.password.description": "Optional credentials for proxy authentication",
  "settings.proxy.bypass.title": "Bypass list",
  "settings.proxy.bypass.description": "Comma-separated hosts that skip the proxy",
  "settings.proxy.apply.title": "Apply changes",
  "settings.proxy.apply.description": "Save the custom proxy configuration",
  "settings.proxy.apply.button": "Apply",
  "settings.proxy.restart.title": "Restart required",
  "settings.proxy.restart.description": "Restart the app so the new proxy takes effect",
  "settings.proxy.restart.button": "Restart now",
  "settings.proxy.error.invalidUrl": "Enter a valid http(s) or socks proxy URL",
