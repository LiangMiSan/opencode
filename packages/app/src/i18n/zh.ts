...
export const dict = {
  ...
  "settings.proxy.section.title": "网络代理",
  "settings.proxy.section.custom": "自定义代理",
  "settings.proxy.mode.title": "代理模式",
  "settings.proxy.mode.description": "选择 OpenCode 网络流量的转发方式",
  "settings.proxy.mode.none": "不使用代理",
  "settings.proxy.mode.system": "使用系统代理",
  "settings.proxy.mode.custom": "自定义代理",
  "settings.proxy.url.title": "代理地址",
  "settings.proxy.url.description": "HTTP、HTTPS 或 SOCKS 代理地址",
  "settings.proxy.username.title": "用户名",
  "settings.proxy.username.description": "可选的代理认证凭据",
  "settings.proxy.password.title": "密码",
  "settings.proxy.password.description": "可选的代理认证凭据",
  "settings.proxy.bypass.title": "代理排除列表",
  "settings.proxy.bypass.description": "以逗号分隔，不通过代理访问的主机",
  "settings.proxy.apply.title": "应用变更",
  "settings.proxy.apply.description": "保存自定义代理配置",
  "settings.proxy.apply.button": "应用",
  "settings.proxy.restart.title": "需要重启",
  "settings.proxy.restart.description": "重启应用以使新代理生效",
  "settings.proxy.restart.button": "立即重启",
  "settings.proxy.error.invalidUrl": "请输入合法的 http(s) 或 socks 代理地址",
